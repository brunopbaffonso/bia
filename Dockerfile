...
#RUN cd client && VITE_API_URL=http://bia-alb-695298705.us-east-1.elb.amazonaws.com npm run build
RUN cd client && VITE_API_URL=https://bia.focusti.com.br npm run build
